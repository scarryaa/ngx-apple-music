declare namespace MusicKit {
    ...
    type FetchOptions = { fetchOptions: { method: 'POST' | 'GET' } };

    type APIResponseObject = {data: { data: Array<Activities | Albums | AppleCurators |
    Artists | SearchChartResult<Resource> | Curators | Genres | MusicVideos |
    Playlists | SearchResult<Resource> | Songs | Stations | 
    PersonalRecommendation | Resource | Storefronts> } };
    ...
    class MusicKitAPI {
        ...
        * await music.api.music(`/v1/storefronts/${storefrontId}`, queryParameters);
        * ``` */
        music(path: string, queryParameters?: QueryParameters, options?: FetchOptions): Promise<APIResponseObject>;
    }
}