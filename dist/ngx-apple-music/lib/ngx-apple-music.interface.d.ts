...
export type AlbumAttributes = Required<Pick<Attributes, 'artistName' | 'artwork' | 'genreNames' | 'isCompilation' | 'isComplete' | 'isMasteredForItunes' | 'isSingle' | 'name' | 'trackCount' | 'url'>> & Partial<Pick<Attributes, 'artistUrl' | 'audioVariants' | 'contentRating' | 'copyright' | 'editorialNotes' | 'playParams' | 'recordLabel' | 'releaseDate' | 'upc'>>;
export type ArtistAttributes = Required<Pick<Attributes, 'genreNames' | 'name' | 'url'>> & Partial<Pick<Attributes, 'artwork' | 'editorialNotes'>>;
export type SongAttributes = Required<Pick<Attributes, 'albumName' | 'artistName' | 'artwork' | 'genreNames' | 'hasLyrics' | 'isAppleDigitalMaster' | 'name' | 'previews' | 'url' | 'durationInMillis'>> & Partial<Pick<Attributes, 'artistUrl' | 'attribution' | 'audioVariants' | 'composerName' | 'contentRating' | 'discNumber' | 'editorialNotes' | 'isrc' | 'movementCount' | 'movementName' | 'movementNumber' | 'playParams' | 'releaseDate' | 'trackNumber' | 'workName'>>;
export type MusicVideoAttributes = Required<Pick<Attributes, 'artistName' | 'artwork' | 'durationInMillis' | 'genreNames' | 'has4K' | 'hasHDR' | 'name' | 'previews' | 'url'>> & Partial<Pick<Attributes, 'albumName' | 'artistUrl' | 'contentRating' | 'editorialNotes' | 'isrc' | 'playParams' | 'releaseDate' | 'trackNumber' | 'videoSubType' | 'workId' | 'workName'>>;
export type PlaylistAttributes = Required<Pick<Attributes, 'curatorName' | 'isChart' | 'name' | 'playlistType' | 'url'>> & Partial<Pick<Attributes, 'artwork' | 'description' | 'lastModifiedDate' | 'playParams' | 'trackTypes'>>;
export type StationAttributes = Required<Pick<Attributes, 'artwork' | 'isLive' | 'mediaKind' | 'name' | 'url'>> & Partial<Pick<Attributes, 'durationInMillis' | 'editorialNotes' | 'episodeNumber' | 'contentRating' | 'playParams' | 'stationProviderName'>>;
